...
// v3 (Google OAuth):
// - Botão "Continuar com Google" no topo + divisor. Para OAuth, registrar
//   e logar são o MESMO fluxo: o find-or-create no callback signIn cria a
//   conta na primeira vez. Redireciona para /minha-conta (sem OTP — o
//   email já chega verificado pelo Google).
...
export default function CadastroPage() {
  ...
  const handleGoogleSignIn = () => {
    ...
    // Para OAuth, cadastro e login são o mesmo fluxo — o callback signIn
    // do NextAuth faz find-or-create. Email já verificado → sem OTP.
